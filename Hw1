...
def numbers_and_strings():
    ...
    # Replace "Great" with "Good" in variable m and assign it to a new variable h
    h = m[0:11]+"Good"
...
def dictionaries():
    ...
    #   age => 85
    amazing_grace ={'name':{'frist_name':"Grace", 'last_name':"Hopper"}, 'jobs':["scientist", "engineer"],'age': 85 }
